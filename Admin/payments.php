...
<body>
	...
	<div id="app">
        ...
        <div class="row align-items-center">
                    ...
                    $getBookings = "SELECT user_login.Name,user_login.Contact_No,booking.Booking_ID,payment.* FROM booking,user_login,payment WHERE payment.Booking_ID=booking.Booking_ID AND payment.User_ID=user_login.User_ID";
                    ...
                    <table class="table table-striped">
                        ...
                        ?>
                            <tr>
                                ...
                                <td style="font-weight: bold;color:<?php echo $color; ?>"><?php echo $row["Status"]; ?></td>
                            </tr>
                        <?php
                        }
                        ?>
